...
Shader "FireSight"
{
	...
	SubShader
	{
		...
		uniform float _emmisivestrenth;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_6_0 = ( temp_output_3_0 - step( ( ( ( tex2D( _Texture0, panner31 ).r * tex2D( _Texture0, panner32 ).r ) * tex2DNode41.r ) + tex2DNode41.r ) , _OpacityStep ) );
			float smoothstepResult17 = smoothstep( 0.0 , _OuterColorBlend , i.uv_texcoord.y);
			o.Albedo = ( ( _Color0 * temp_output_3_0 ) + ( temp_output_6_0 * ( ( _Color1 * ( 1.0 - smoothstepResult17 ) ) + ( smoothstepResult17 * _Color2 ) ) ) ).rgb;
			float3 temp_cast_3 = (( temp_output_6_0 * _emmisivestrenth )).xxx;
...
/*ASEBEGIN
Version=17700
7;213;2560;1331;294.9518;-190.7928;1;True;True
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;-1355.713,314.4427;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-426.8713,659.0721;Inherit;False;Property;_OpacityStep;Opacity Step;7;0;Create;True;0;0;False;0;0.5;0.774;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;3;-31.87134,304.0721;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;14;-65.87134,579.0721;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;6;208.1287,407.0721;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;21;580.1287,1115.072;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;5;668.1287,490.0721;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;44;873.0482,1026.793;Inherit;False;Property;_emmisivestrenth;emmisive strenth;12;0;Create;True;0;0;False;0;1;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=88F8DDB2DDF6B3E742F7CA24CDF1076064C2E903