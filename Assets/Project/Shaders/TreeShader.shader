...
Shader "TreeShader"
{
	Properties
	{
		_TopColor1("Top Color", Color) = (1,1,1,0)
		...
		_BottomColor1("Bottom Color", Color) = (0,0,0,0)
		_Gradientsize1("Gradient size", Float) = 0.82
		_Gradientposition1("Gradient position", Float) = 1
		_Gradientintensity1("Gradient intensity", Float) = 1
		_Contrast1("Contrast", Float) = 1
	...
	SubShader
	{
		...
		uniform float _Gradientintensity1;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_cast_2 = (_Gradientposition1).xxx;
			float3 temp_cast_3 = (_Gradientsize1).xxx;
			float4 lerpResult43 = lerp( _TopColor1 , _BottomColor1 , pow( ( distance( max( ( abs( ( temp_cast_1 - temp_cast_2 ) ) - ( temp_cast_3 * float3( 0.5,0.5,0.5 ) ) ) , float3( 0,0,0 ) ) , float3( 0,0,0 ) ) / _Gradientintensity1 ) , 0.5 ));
			o.Albedo = CalculateContrast(_Contrast1,lerpResult43).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17700
0;36;2560;1343;603.363;-1192.385;1;True;True
...
Node;AmplifyShaderEditor.CosOpNode;14;5.264139,1800.431;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-710.5493,-764.77;Float;False;Property;_Gradientintensity1;Gradient intensity;8;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-705.554,-855.7173;Float;False;Property;_Gradientsize1;Gradient size;6;0;Create;True;0;0;False;0;0.82;0.82;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-682.3979,-989.829;Float;False;Property;_Gradientposition1;Gradient position;7;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-322.4354,-538.1615;Float;False;Constant;_devider1;devider;0;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;40;-403.7979,-1608.943;Float;False;Property;_BottomColor1;Bottom Color;5;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;41;-397.7979,-1805.943;Float;False;Property;_TopColor1;Top Color;0;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;42;1114.727,-649.0155;Float;False;Property;_Contrast1;Contrast;9;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=DC0F0A3C5462157A5A6E17106717D1FEF789C331